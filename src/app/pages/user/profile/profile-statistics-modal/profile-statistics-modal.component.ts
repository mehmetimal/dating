...
@Component({
  selector: 'app-profile-statistics-modal',
  templateUrl: './profile-statistics-modal.component.html',
  styleUrls: ['./profile-statistics-modal.component.scss']
})
export class ProfileStatisticsModalComponent implements OnInit {
