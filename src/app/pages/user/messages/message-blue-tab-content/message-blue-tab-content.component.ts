...
@Component({
    selector: 'app-message-blue-tab-content',
    templateUrl: './message-blue-tab-content.component.html',
    styleUrls: ['./message-blue-tab-content.component.scss']
})
export class MessageBlueTabContentComponent implements OnInit {
    public udcFolder = environment.udcFolder;
    @Input() loggedUser;
    @Input() friendsBlueTab;
