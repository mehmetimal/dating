...
@Component({
  selector: 'app-message-content-hobby-piercing',
  templateUrl: './message-content-hobby-piercing.component.html'
})
export class MessageContentHobbyPiercingComponent implements OnInit {
  @Input() msg;
  socket: Socket;
  ...
  answerPiercingQuestion(param) {
    this.userService.updateUserHobby('PIERCING', param).subscribe(value => {
