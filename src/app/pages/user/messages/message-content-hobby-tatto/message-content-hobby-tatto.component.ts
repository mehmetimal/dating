...
@Component({
  selector: 'app-message-content-hobby-tatto',
  templateUrl: './message-content-hobby-tatto.component.html'
})
export class MessageContentHobbyTattoComponent implements OnInit {
  ...
  answerTattoQuestion(param) {
    this.userService.updateUserHobby('TATTO', param).subscribe(value => {
